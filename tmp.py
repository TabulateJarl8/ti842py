...
def main():
	d = dialog.Dialog()
	menu = d.menu("HI", choices=[('1.', 'OPTION 1'), ('2.', 'OPTION 2')])
	if menu[1] == "1.":
		goto .lbl1
	if menu[1] == "2.":
		goto .lbl2
	clear()
	print("WOW CANT YOU WANT TO EXPERIENCE THE GOODNESS?!?!?", sep="")
	print("WE WILL NOW BE ASSIGNING A VARIABLE", sep="")
	X = 3
	print("HERE IS WHAT X IS NOW:", X, "ARENT YOU SO HAPPY", sep="")
	print("LET US TEST SOME THINGS NOW", sep="")
	if X == 2:
		print("X IS 2", sep="")
	elif X == 4:
		print("X IS 4", sep="")
	else:
		print("X IS NOT 3 OR 4", sep="")
